...
const WhatsInsideSection = () => {
  ...
  const liaCardsData = [{
    ...
    previewBullets: ["50+ Video Modules (7 comprehensive weeks)", "Client Acquisition Systems (attract real companies)", "Fulfillment SOPs (scale without quality loss)"],
    allBullets: ["50+ Video Modules (7 comprehensive weeks)", "Client Acquisition Systems (attract real companies)", "Fulfillment SOPs (scale without quality loss)", "Sales Masterclass (close $5K-$50K+ contracts)", "Personal Branding Blueprint (authority positioning)", "LinkedIn Outbound System (predictable pipeline)"],
    ...
    previewBullets: ["50+ Content Templates (hooks, posts, lead magnets)", "DM & Outreach Scripts (connection requests, InMails)", "Proposal Templates ($5K-$50K+ closing docs)"],
    allBullets: ["50+ Content Templates (hooks, posts, lead magnets)", "DM & Outreach Scripts (connection requests, InMails)", "Proposal Templates ($5K-$50K+ closing docs)", "Onboarding SOPs (client intake, KPI tracking)", "Fulfillment Playbooks (delivery, reporting, scaling)", "Personal Brand Assets (profiles, banners, bios)", "Automation Workflows (AI agents, content systems)"],
    ...
    previewBullets: ["8+ Industry Playbooks (AI, SaaS, Finance, Real Estate, etc.)", "Niche Positioning Guides (stand out in your vertical)", "Vertical-Specific Templates (content, DM scripts, offers)"],
    allBullets: ["8+ Industry Playbooks (AI, SaaS, Finance, Real Estate, etc.)", "Niche Positioning Guides (stand out in your vertical)", "Vertical-Specific Templates (content, DM scripts, offers)", "Industry Case Studies (real operators, real results)", "ICP Mapping (find ideal clients)", "Competitive Analysis Frameworks (beat incumbents)"],
    ...
    isPremium: true,
    previewBullets: ["Brand Equity Engineering (belief installation, positioning)", "Viral Content Science (predictable 1M+ view posts)", "Client Retention Mastery (upsell frameworks, 0% churn)"],
    allBullets: ["Brand Equity Engineering (belief installation, positioning)", "Viral Content Science (predictable 1M+ view posts)", "Client Retention Mastery (upsell frameworks, 0% churn)", "Account Protection Protocols (never get banned)", "Competitive Domination (be #1 in your niche)", "AI & Automation Mastery (custom agents, batch systems)", "Mystery Module (join to find out)"],
    ...
    isPremium: true,
    previewBullets: ["Tax Optimization Solutions (operator-friendly accountants)", "Payment Processing (high-risk merchants, international)", "OTC Trading Connections (scaling past $100K/month)"],
    allBullets: ["Tax Optimization Solutions (operator-friendly accountants)", "Payment Processing (high-risk merchants, international)", "OTC Trading Connections (scaling past $100K/month)", "Social Media Insiders (LinkedIn/X troubleshooting contacts)", "Legal Protection Resources (contracts, entity setup)", "Scaling Infrastructure (hiring, ops, systems beyond $50K/month)"],
  ...
  const b2bCardsData = [{
    ...
    previewBullets: ["Fundamentals Module (mindset, infrastructure, setup)", "Personal Branding Blueprint (Forbes-level positioning)", "Profile Optimization System (conversion-focused)"],
    allBullets: ["Fundamentals Module (mindset, infrastructure, setup)", "Personal Branding Blueprint (Forbes-level positioning)", "Profile Optimization System (conversion-focused)", "Content Strategy Framework (authority-building)"],
    footer: "Lifetime access. Updated quarterly."
  }, {
    id: 2,
    tier: "both",
    ...
    previewBullets: ["LinkedIn Outbound System (DM frameworks, follow-ups)", "Sales Masterclass (discovery calls, closing)", "Lead List Building (Sales Navigator mastery)"],
    allBullets: ["LinkedIn Outbound System (DM frameworks, follow-ups)", "Sales Masterclass (discovery calls, closing)", "Lead List Building (Sales Navigator mastery)", "Conversion Optimization (booking rate improvement)"],
    ...
    previewBullets: ["Content Templates (hooks, posts, lead magnets)", "Profile Templates (headlines, about sections, banners)", "Outreach Scripts (DM frameworks, InMails)"],
    allBullets: ["Content Templates (hooks, posts, lead magnets)", "Profile Templates (headlines, about sections, banners)", "Outreach Scripts (DM frameworks, InMails)", "Lead Magnet Templates"],
    ...
    isPremium: true,
    isDFY: true,
    previewBullets: ["Brand Equity Engineering", "Viral Content Science (predictable 1M+ views)", "Algorithm Mastery"],
    allBullets: ["Brand Equity Engineering", "Viral Content Science (predictable 1M+ views)", "Algorithm Mastery", "Account Protection Protocols", "Competitive Domination", "[REDACTED]", "Mystery Module"],
    testimonial: {
    ...
    isPremium: true,
    isDFY: true,
    previewBullets: ["White-Glove Content Creation (ghostwritten for you)", "Strategic Positioning (Forbes-level authority)", "Profile Optimization (done for you)"],
    allBullets: ["White-Glove Content Creation (ghostwritten for you)", "Strategic Positioning (Forbes-level authority)", "Profile Optimization (done for you)", "Dedicated Account Manager (weekly strategy calls)", "Performance Reporting (monthly ROI tracking)"],
  ...
  return <section className="py-20 md:py-32 bg-background">
      <div id="whats-inside" className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-6">
          <div className={`inline-flex items-center gap-3 px-5 py-2.5 rounded-full border transition-all ${activePath === 'lia' ? 'bg-orange-50 border-orange-200 hover:border-orange-300' : 'bg-blue-50 border-blue-200 hover:border-blue-300'}`}>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${activePath === 'lia' ? 'bg-orange-100' : 'bg-blue-100'}`}>
              <Sparkles className={`w-4 h-4 ${activePath === 'lia' ? 'text-orange-600' : 'text-blue-600'}`} />
            </div>
            <span className={`text-sm font-semibold ${activePath === 'lia' ? 'text-orange-900' : 'text-blue-900'}`}>
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex items-center gap-2 p-1 bg-muted rounded-lg border border-border">
            <button onClick={() => setViewMode("all")} className={`px-6 py-2.5 rounded-md text-sm font-semibold transition-all ${viewMode === "all" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}>
              All Features
            </button>
            <button onClick={() => setViewMode("compare")} className={`px-6 py-2.5 rounded-md text-sm font-semibold transition-all ${viewMode === "compare" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}>
              Compare Tiers
            </button>
          </div>
        </div>
        ...
        {/* Cards Grid */}
        {viewMode === "all" ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-7xl mx-auto mb-16">
          ...
          if (card.isPremium) {
            return <div key={card.id} className="relative rounded-2xl overflow-hidden animate-fade-in" style={{
              animationDelay
            }}>
                    {/* Premium Badge */}
                    ...
                    <div className="relative h-full border-2 border-amber-500/50 rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden animate-pulse-glow">
                      ...
                      <div className="relative p-8 pt-4">
                        ...
                        <div className="space-y-2 mb-4">
                          {card.previewBullets?.map((bullet, idx) => <div key={idx} className="flex items-start gap-2 text-gray-300">
                          ...
                          {card.allBullets && card.allBullets.length > 3 && <>
                              {card.allBullets.slice(3).map((bullet, idx) => <div key={idx} className="flex items-start gap-2 text-gray-500">
                        ...
                        {'testimonial' in card && card.testimonial && typeof card.testimonial === 'object' && 'quote' in card.testimonial && 'author' in card.testimonial && <div className="mb-4 p-4 bg-white/5 rounded-lg border border-white/10">
          ...
          if (card.tier === "split") {
            return <div key={card.id} className="relative rounded-2xl overflow-hidden animate-fade-in border-2 border-primary/20 hover:border-primary/40 transition-all" style={{
              animationDelay
            }}>
                    {/* Split Badge */}
                    <div className="absolute top-4 right-4 z-20">
                      <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full shadow-lg ${activePath === 'lia' ? 'bg-gradient-to-r from-orange-500/90 to-orange-400/90' : 'bg-gradient-to-r from-blue-500/90 to-blue-400/90'}`}>
                    ...
                    <div className="relative h-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
                      ...
                      <div className="relative p-6">
                        <div className="mb-4">
                          <div className={`w-12 h-12 rounded-xl backdrop-blur-sm flex items-center justify-center border ${activePath === 'lia' ? 'bg-orange-500/20 border-orange-500/30' : 'bg-blue-500/20 border-blue-500/30'}`}>
                            <Icon className={`w-6 h-6 ${activePath === 'lia' ? 'text-orange-500' : 'text-blue-500'}`} />
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
                            ...
                            <div className="space-y-2">
                              {card.midTicket?.slice(0, 2).map((item, idx) => <div key={idx} className="flex items-start gap-2">
                          ...
                          <div className="bg-gradient-to-br from-amber-500/10 to-yellow-500/10 rounded-xl p-4 border border-amber-500/30">
                            ...
                            <div className="space-y-2">
                              {card.highTicket?.slice(0, 2).map((item, idx) => <div key={idx} className="flex items-start gap-2">
                                  <Crown className="w-4 h-4 text-amber-500 mt-0.5 flex-shrink-0" />
                                  <span className="text-xs text-gray-300">{item}</span>
                                </div>)}
                            </div>
                        ...
                        {/* Expandable section */}
                        {isExpanded && <div className="mt-4 space-y-4 animate-fade-in">
                            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
                              ...
                              <div className="space-y-2">
                                {card.midTicket?.map((item, idx) => <div key={idx} className="flex items-start gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-xs text-gray-300">{item}</span>
                                  </div>)}
                              </div>
                            ...
                            <div className="bg-gradient-to-br from-amber-500/10 to-yellow-500/10 rounded-xl p-4 border border-amber-500/30">
                              ...
                              <div className="space-y-2">
                                {card.highTicket?.map((item, idx) => <div key={idx} className="flex items-start gap-2">
                                    <Crown className="w-4 h-4 text-amber-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-xs text-gray-300">{item}</span>
                                  </div>)}
                              </div>
                        ...
                        <button onClick={() => toggleCardExpansion(card.id)} className={`w-full mt-4 text-sm transition-colors flex items-center justify-center gap-2 ${activePath === 'lia' ? 'text-orange-500 hover:text-orange-400' : 'text-blue-500 hover:text-blue-400'}`}>
          ...
          return <div key={card.id} className="relative rounded-2xl overflow-hidden animate-fade-in border-2 border-primary/20 hover:border-primary/40 transition-all hover:shadow-xl" style={{
            animationDelay
          }}>
                  {/* Both Tiers Badge */}
                  <div className="absolute top-4 right-4 z-20">
                    <div className={`flex items-center gap-1.5 px-3 py-1.5 backdrop-blur-sm rounded-full shadow-md ${activePath === 'lia' ? 'bg-orange-500/90' : 'bg-blue-500/90'}`}>
                      <CheckCircle2 className="w-4 h-4 text-white" />
                    ...
                    <div className="relative p-6">
                      ...
                      <div className="space-y-2 mb-4">
                        {card.previewBullets?.map((bullet, idx) => <div key={idx} className="flex items-start gap-2">
                            <CheckCircle2 className={`w-4 h-4 mt-0.5 flex-shrink-0 ${activePath === 'lia' ? 'text-orange-500' : 'text-blue-500'}`} />
                            <span className="text-sm text-gray-300">{bullet}</span>
                          </div>)}
                      </div>

                      {/* Expandable full list */}
                      {isExpanded && card.allBullets && <div className="space-y-2 mb-4 animate-fade-in">
                          {card.allBullets.slice(3).map((bullet, idx) => <div key={idx} className="flex items-start gap-2">
                              <CheckCircle2 className={`w-4 h-4 mt-0.5 flex-shrink-0 ${activePath === 'lia' ? 'text-orange-500' : 'text-blue-500'}`} />
                              <span className="text-sm text-gray-300">{bullet}</span>
                            </div>)}
                        </div>}

                      <button onClick={() => toggleCardExpansion(card.id)} className={`text-sm transition-colors flex items-center gap-2 ${activePath === 'lia' ? 'text-orange-500 hover:text-orange-400' : 'text-blue-500 hover:text-blue-400'}`}>
            ...
            <div className="space-y-6">
              <div className="bg-card rounded-xl p-6 border-2 border-primary/30">
                ...
                <div className="space-y-4">
                  {cardsData.filter(c => c.tier === "both" || c.tier === "split").map(card => <div key={card.id} className="bg-muted/50 rounded-lg p-4 border border-border">
                      <div className="flex items-center gap-3 mb-2">
                        <card.icon className="w-5 h-5 text-primary" />
                        <h4 className="font-bold text-foreground">{card.title}</h4>
                      </div>
                      {card.tier === "split" ? <ul className="space-y-1 ml-8">
                          {card.midTicket?.slice(0, 2).map((item, idx) => <li key={idx} className="text-sm text-muted-foreground">• {item}</li>)}
                        </ul> : <ul className="space-y-1 ml-8">
                          {card.previewBullets?.map((item, idx) => <li key={idx} className="text-sm text-muted-foreground">• {item}</li>)}
                        </ul>}
                    </div>)}
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-amber-500/10 to-yellow-500/10 rounded-xl p-6 border-2 border-amber-500/50 animate-pulse-glow">
                ...
                <div className="space-y-4">
                  {cardsData.map(card => {
                if (card.tier === "high") {
                  return <div key={card.id} className="bg-background/80 rounded-lg p-4 border border-amber-500/30">
                          <div className="flex items-center gap-3 mb-2">
                ...
                if (card.tier === "split") {
                  return <div key={card.id} className="bg-background/80 rounded-lg p-4 border border-amber-500/30">
                          ...
                          <ul className="space-y-1 ml-8">
                            {card.highTicket?.slice(0, 3).map((item, idx) => <li key={idx} className="text-sm text-muted-foreground">• {item}</li>)}
                          </ul>
                        </div>;
                }
                return null;
