          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/30 rounded-2xl p-8">
              ...
              <p className="text-center text-sm text-muted-foreground mt-4">
                ✓ Instant access ✓ 500+ active operators ✓ 90-day guarantee
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <TestimonialCard
              name="Vasilije Simic"
              image={vasilijeSimic}
              quote="Zero experience to $25K/month agency. I guarantee my clients booked meetings in 90 days. The framework works."
